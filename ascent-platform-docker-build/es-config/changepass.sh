...
curl -XPOST -s -u elastic:$ES_PASSWORD $ES_URL/_xpack/security/user/$ZIPKIN_STORAGE_ELASTIC_SEARCH_USERNAME -H 'Content-Type: application/json' -d "$(generate_user_data $ZIPKIN_STORAGE_ELASTIC_SEARCH_PASSWORD)"
